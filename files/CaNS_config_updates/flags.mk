...
override FFLAGS += -ffree-line-length-0
FFLAGS_MOD_DIR := -J
endif
...
FFLAGS_MOD_DIR := -module
ifeq ($(strip $(GPU)),1)
override FFLAGS += -acc -cuda -Minfo=accel -gpu=cc60,cc70,cc80,cc89,cuda12.9
endif
endif
...
ifeq ($(strip $(FCOMP)),GNU)
override FFLAGS += -O3 -g -march=native -mtune=native
endif
ifeq ($(findstring INTEL,$(strip $(FCOMP))),INTEL)
override FFLAGS += -O3
endif
...
ifeq ($(strip $(FCOMP)),GNU)
override FFLAGS += -Ofast -march=native -mtune=native
endif
ifeq ($(findstring INTEL,$(strip $(FCOMP))),INTEL)
